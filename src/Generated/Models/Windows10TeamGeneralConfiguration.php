    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'azureOperationalInsightsBlockTelemetry' => function (ParseNode $n) use ($o) { $o->setAzureOperationalInsightsBlockTelemetry($n->getBooleanValue()); },
            'azureOperationalInsightsWorkspaceId' => function (ParseNode $n) use ($o) { $o->setAzureOperationalInsightsWorkspaceId($n->getStringValue()); },
            'azureOperationalInsightsWorkspaceKey' => function (ParseNode $n) use ($o) { $o->setAzureOperationalInsightsWorkspaceKey($n->getStringValue()); },
            'connectAppBlockAutoLaunch' => function (ParseNode $n) use ($o) { $o->setConnectAppBlockAutoLaunch($n->getBooleanValue()); },
            'maintenanceWindowBlocked' => function (ParseNode $n) use ($o) { $o->setMaintenanceWindowBlocked($n->getBooleanValue()); },
            'maintenanceWindowDurationInHours' => function (ParseNode $n) use ($o) { $o->setMaintenanceWindowDurationInHours($n->getIntegerValue()); },
            'maintenanceWindowStartTime' => function (ParseNode $n) use ($o) { $o->setMaintenanceWindowStartTime($n->getTimeValue()); },
            'miracastBlocked' => function (ParseNode $n) use ($o) { $o->setMiracastBlocked($n->getBooleanValue()); },
            'miracastChannel' => function (ParseNode $n) use ($o) { $o->setMiracastChannel($n->getEnumValue(MiracastChannel::class)); },
            'miracastRequirePin' => function (ParseNode $n) use ($o) { $o->setMiracastRequirePin($n->getBooleanValue()); },
            'settingsBlockMyMeetingsAndFiles' => function (ParseNode $n) use ($o) { $o->setSettingsBlockMyMeetingsAndFiles($n->getBooleanValue()); },
            'settingsBlockSessionResume' => function (ParseNode $n) use ($o) { $o->setSettingsBlockSessionResume($n->getBooleanValue()); },
            'settingsBlockSigninSuggestions' => function (ParseNode $n) use ($o) { $o->setSettingsBlockSigninSuggestions($n->getBooleanValue()); },
            'settingsDefaultVolume' => function (ParseNode $n) use ($o) { $o->setSettingsDefaultVolume($n->getIntegerValue()); },
            'settingsScreenTimeoutInMinutes' => function (ParseNode $n) use ($o) { $o->setSettingsScreenTimeoutInMinutes($n->getIntegerValue()); },
            'settingsSessionTimeoutInMinutes' => function (ParseNode $n) use ($o) { $o->setSettingsSessionTimeoutInMinutes($n->getIntegerValue()); },
            'settingsSleepTimeoutInMinutes' => function (ParseNode $n) use ($o) { $o->setSettingsSleepTimeoutInMinutes($n->getIntegerValue()); },
            'welcomeScreenBackgroundImageUrl' => function (ParseNode $n) use ($o) { $o->setWelcomeScreenBackgroundImageUrl($n->getStringValue()); },
            'welcomeScreenBlockAutomaticWakeUp' => function (ParseNode $n) use ($o) { $o->setWelcomeScreenBlockAutomaticWakeUp($n->getBooleanValue()); },
            'welcomeScreenMeetingInformation' => function (ParseNode $n) use ($o) { $o->setWelcomeScreenMeetingInformation($n->getEnumValue(WelcomeScreenMeetingInformation::class)); },
        ]);
    }
