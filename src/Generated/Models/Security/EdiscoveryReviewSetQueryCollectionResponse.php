...
class EdiscoveryReviewSetQueryCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<EdiscoveryReviewSetQuery>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EdiscoveryReviewSetQueryCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(EdiscoveryReviewSetQuery::class, 'createFromDiscriminatorValue'))); },
        ];
    }
