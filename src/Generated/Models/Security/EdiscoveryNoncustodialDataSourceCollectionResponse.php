...
class EdiscoveryNoncustodialDataSourceCollectionResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<EdiscoveryNoncustodialDataSource>|null $value The value property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): EdiscoveryNoncustodialDataSourceCollectionResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'value' => function (ParseNode $n) use ($o) { $o->setValue($n->getCollectionOfObjectValues(array(EdiscoveryNoncustodialDataSource::class, 'createFromDiscriminatorValue'))); },
        ];
    }
